...
class SpritesCreator:
    ...
    @staticmethod
    def convert_dict_alpha(images):
        for key in images.keys():
            images[key] = images[key].convert_alpha()
        return images

    def create_tank_dict(self, folder, img_prefix):
